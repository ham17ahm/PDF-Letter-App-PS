module.exports = {
  ...
  "extraction_requirements": {
    ...
    "summary_content": {
      "description": "Concise executive summary of letter content written in Urdu",
      "requirements": {
  ...
  "examples": [
    ...
    },
    {
      ...
      "output": "مکرمہ عطیہ شیخ صاحبہ (Add: 3373 Cutler Cres SW Edmonton, AB T6W 2N4 Canada) نے حضورانور ایدہ اللہ تعالیٰ بنصرہ العزیز کی خدمت میں لکھا ہے کہ جب سے میں Edmonton آئی ہوں ڈیپریشن کا شکار ہوں۔ گزشتہ سالوں میں یہاں کی بعض لجنات نے میرے خلاف نفرت پھیلائی ہے جس کی وجہ سے لوگوں کا میرے ساتھ سلوک بدل گیا ہے۔ حتیٰ کہ میرے ساتھ صحیح طرح سلام بھی نہیں کرتے۔ کچھ لوگوں نے مجھے آکر کہا کہ ''ہم نے آپ کے بارہ میں باتیں سنی ہوئی تھیں لیکن آپ سے مل کر ہماری رائے آپ کے بارہ میں بدل گئ ہے۔'' محسوس ہوتا ہے کہ میرا Trust کئی دفعہ ٹوٹا ہے۔ میں نے اپنے آپ کو مکمل طور پر Isolate کر لیا ہے۔ میرا کوئی حقیقی دوست نہیں ہے اور اپنے میاں سے میں اتنی آسانی سے بات نہیں کر سکتی۔ میں تنہا محسوس کرتی ہوں۔ جماعتی کام کےلئے اپنا جوش کھو بیٹھی ہوں۔ ایمان کی کمی کی وجہ سے خود اعتمادی کم ہے اور لوگوں کی باتوں کا اثر ہو رہا ہے۔ ڈاکٹر نے مجھے Depression اور Anxiety کی دوائی بھی دی ہے۔\\nحضورانور نے اس پر آپ سے رپورٹ منگوانے کی ہدایت فرمائی ہے۔ حسب ارشاد براہ مہربانی اس بارہ میں اپنی رپورٹ سے حضورانور کو مطلع فرمائیں۔ جزاکم اللہ احسن الجزاء"
    },
    {
