module.exports = {
  id: "janaza-report-urd",
  label: "Janazah Report (Urdu)",
  ...
  "letter_format": {
    "template": "[مکرم/مکرمہ] [لکھنے والے کا نام] [صاحب/صاحبہ] (Add: [[Address Details of Author]]) نے حضورانور ایدہ اللہ تعالیٰ بنصرہ العزیز کی خدمت میں [مرحوم/مرحومہ کا نام اور تعلق] کی نماز جنازہ غائب پڑھانے کی درخواست کی ہے۔ [مرحوم/مرحومہ] کی وفات [تاریخ وفات] کو بعمر [وفات پر عمر] سال [جگہ] میں ہوئی تھی۔ اناللہ وانا الیہ راجعون۔\n\nحسب ارشاد براہ مہربانی [مرحوم/مرحومہ] کے خاندانی و عمومی تعارف، جماعتی تعلق نیز [موصی/موصیہ] ہونے کے بارہ میں اپنی رپورٹ سے حضورانور کو مطلع فرمائیں۔ جزاکم اللہ احسن الجزاء",
    "components": {
      "opening_section": {
