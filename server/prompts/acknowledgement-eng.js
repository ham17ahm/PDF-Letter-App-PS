module.exports = {
  id: "acknowledgement-eng",
  label: "PS Acknowledgement Report (Eng)",
  ...
  "letter_template": {
    "format": "Huzoor Anwar (may Allah be his Helper) has received your report dated [date_of_report] regarding the matter of [executive_summary]. In compliance with the directives and guidance of Huzoor Anwar (aa), this is to formally acknowledge the receipt of your report. Jazakumullah",
    "variables": {
      "date_of_report": {
